...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    locationTableViewController = [[LocationTableViewController alloc] init];
    
    navigationController = [[UINavigationController alloc] initWithRootViewController:locationTableViewController]; 
